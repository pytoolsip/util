...
# @Last Modified time: 2019-05-30 17:01:48
import os;
import hashlib;
...
if __name__ == '__main__':
	...
	# 获取文件md5数据
	fileMd5Map = getFileMd5Map(tempPath);
	# 保存json文件
	saveJson(fileMd5Map, os.path.join(tarPath, "fileMd5Map.json"));
	# 删除临时文件
